...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#171717] border border-[#262626] mb-8"
            >
            ...
            {/* Main Heading */}
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-[#E5E5E5] leading-tight tracking-tight mb-6 max-w-4xl">
              We Build Digital<br />
              Products That Scale
            </h1>

            {/* Subheading/Description */}
            <p className="text-base md:text-lg lg:text-xl text-[#A3A3A3] leading-relaxed font-light max-w-2xl">
      ...
      <section className="py-16 md:py-20 border-t border-[#171717]">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <motion.div
              ...
              className="pb-8 md:pb-12 pr-0 md:pr-8 border-b border-[#171717] md:border-b-0 md:border-r border-[#171717]"
            >
              <div className="text-[#A3A3A3] text-sm md:text-base font-light mb-3">01</div>
            ...
            <motion.div
              ...
              className="pb-8 md:pb-12 pl-0 md:pl-8 border-b border-[#171717]"
            >
              <div className="text-[#A3A3A3] text-sm md:text-base font-light mb-3">02</div>
              <h3 className="text-xl md:text-2xl font-bold text-[#E5E5E5] mb-4 tracking-tight">
                UI/UX Design
              </h3>
              <p className="text-base text-[#A3A3A3] leading-relaxed font-light">
            ...
            <motion.div
              ...
              className="pt-8 md:pt-12 pr-0 md:pr-8 border-t border-[#171717] md:border-t-0 md:border-r border-[#171717]"
            >
              <div className="text-[#A3A3A3] text-sm md:text-base font-light mb-3">03</div>
              <h3 className="text-xl md:text-2xl font-bold text-[#E5E5E5] mb-4 tracking-tight">
            ...
            <motion.div
              ...
              className="pt-8 md:pt-12 pl-0 md:pl-8 border-t border-[#171717]"
            >
              <div className="text-[#A3A3A3] text-sm md:text-base font-light mb-3">04</div>
              <h3 className="text-xl md:text-2xl font-bold text-[#E5E5E5] mb-4 tracking-tight">
              ...
              >
                ...
                >
                  <div className="h-full flex flex-col border border-[#171717] rounded-lg overflow-hidden bg-[#0A0A0A] hover:border-[#262626] transition-colors duration-200">
                    {/* Image */}
                    <div className="relative overflow-hidden aspect-video bg-[#0A0A0A] group-hover:opacity-90 transition-opacity duration-200">
                      <SafeImage
                    ...
                    <div className="flex flex-col flex-1 p-6">
                      ...
                      <div className="flex items-center justify-end mt-auto">
                        <svg 
                          className="h-5 w-5 text-[#737373] group-hover:text-[#A3A3A3] group-hover:translate-x-1 transition-all duration-200" 
                          fill="none" 
                          stroke="currentColor" 
                          viewBox="0 0 24 24"
                        >
